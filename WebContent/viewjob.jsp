...
PreparedStatement pstmt = con.prepareStatement("select * from job where hrid=? ");
pstmt.setInt(1, Locker.getHrid());
...
<TD><a href= "viewshort.jsp?id=<%= rs.getInt(1)%>">View Shortlisted Candidates</a></TD>
</tr>
<%} %>
</tbody>
</table><br><br><br>
 <div class="mrgn-30-top">
                <button type="submit"  class="btn btn-larger btn-block"/><a href=hrlogin.html>
                Back to dashboard</a>
                </button>
                </div>
